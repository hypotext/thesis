...
HMAC-DRBG consists of four main functions, $Instantiate$, $Generate$, $Update$, and $Reseed$, and another function we don't model called $getEntropy$. Refer to NIST SP 800-90A for the pseudocode. 

For simplicity, we omit the $provided\_data$ and $additional\_input$ parameters. Our proof of security does not include them.\\
