...
HMAC-DRBG functions: Instantiate, Generate, Update, Reseed. State: (K, V, number of calls.) (This might go in the HMAC-DRBG section)
...
Formal def of indistinguishability, adversaries, etc.
