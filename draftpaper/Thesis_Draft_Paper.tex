...
\begin{itemize}
\item actually write this proof on paper
\item Formal def of indist., adversaries, etc.
\item Games (in math, not code?)
\item Hybrid argument
\item Reductions/games (PRF, random function)
\item dealing with key/v updating 
\item direction of proof we COULD have taken
\item concrete bound
\end{itemize}
...
\begin{itemize}
\item Formal def of backtracking resistance and adversary
\item Reductions/games re-using the previous one
\end{itemize}
