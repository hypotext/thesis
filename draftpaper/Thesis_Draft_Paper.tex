...
\begin{lem} $|\Pr[G\_real\_2] - \Pr[G\_intermediate\_2]| \leq PRF\_Advantage.$ \end{lem}
...
Then we bound the difference between the intermediate and the ideal-world game.

\begin{thm} $| \Pr[G\_intermediate] - \Pr[G\_ideal]| \leq \f{n^2}{2^c} $ \end{thm}
\begin{proof} 
Identical until bad\\
Probability of collisions \end{proof}

This yields our final result, which is:
...
Reductions/games (PRF, random function)
