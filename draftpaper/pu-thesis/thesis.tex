...
\chapter{Overview of the Foundational Cryptography Framework}
...
\section{A simple example of reasoning about programs in PRPL}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Outline of machine-checked proofs}
...
\section{Current limitations of the formal proof}
...
\section{Comments on the Coq development}
...
\section{Comments on HMAC-DRBG's design}
...
\chapter{Linking our crypto spec with the functional spec}
...
\section{Bridging the gaps between the specifications}
