...
\adviser{Andrew W. Appel and Matthew Green}  %replace with the full name of your adviser
...
\li|https://github.com/hypotext/fcf/blob/master/src/examples/HMAC_DRBG_nonadaptive.v| \\

The HMAC-DRBG functional correctness proof may be found in this repository. \\

\li|https://bitbucket.org/naphatkrit/rng| \\

The Foundational Cryptography Framework may be found in this repository. 

\li|https://github.com/adampetcher/fcf| \\

The full verification of HMAC may be found in this repository, subdirectories $sha$, $fcf$, and $hmacfcf$. \\
